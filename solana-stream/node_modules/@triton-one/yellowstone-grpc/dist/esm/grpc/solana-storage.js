        ...
        return {
            ...
            accountKeys: globalThis.Array.isArray(object?.accountKeys)
                ...
                : globalThis.Array.isArray(object?.account_keys)
                    ? object.account_keys.map((e) => bytesFromBase64(e))
                    : [],
            ...
            addressTableLookups: globalThis.Array.isArray(object?.addressTableLookups)
                ...
                : globalThis.Array.isArray(object?.address_table_lookups)
                    ? object.address_table_lookups.map((e) => MessageAddressTableLookup.fromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
        ...
        return {
            ...
            preBalances: globalThis.Array.isArray(object?.preBalances)
                ...
                : globalThis.Array.isArray(object?.pre_balances)
                    ? object.pre_balances.map((e) => globalThis.String(e))
                    : [],
            postBalances: globalThis.Array.isArray(object?.postBalances)
                ...
                : globalThis.Array.isArray(object?.post_balances)
                    ? object.post_balances.map((e) => globalThis.String(e))
                    : [],
            innerInstructions: globalThis.Array.isArray(object?.innerInstructions)
                ...
                : globalThis.Array.isArray(object?.inner_instructions)
                    ? object.inner_instructions.map((e) => InnerInstructions.fromJSON(e))
                    : [],
            ...
            logMessages: globalThis.Array.isArray(object?.logMessages)
                ...
                : globalThis.Array.isArray(object?.log_messages)
                    ? object.log_messages.map((e) => globalThis.String(e))
                    : [],
            ...
            preTokenBalances: globalThis.Array.isArray(object?.preTokenBalances)
                ...
                : globalThis.Array.isArray(object?.pre_token_balances)
                    ? object.pre_token_balances.map((e) => TokenBalance.fromJSON(e))
                    : [],
            postTokenBalances: globalThis.Array.isArray(object?.postTokenBalances)
                ...
                : globalThis.Array.isArray(object?.post_token_balances)
                    ? object.post_token_balances.map((e) => TokenBalance.fromJSON(e))
                    : [],
            rewards: globalThis.Array.isArray(object?.rewards)
                ? object.rewards.map((e) => Reward.fromJSON(e))
                : [],
            ...
            computeUnitsConsumed: isSet(object.computeUnitsConsumed)
                ...
                : isSet(object.compute_units_consumed)
                    ? globalThis.String(object.compute_units_consumed)
                    : undefined,
            costUnits: isSet(object.costUnits)
                ? globalThis.String(object.costUnits)
                : isSet(object.cost_units)
                    ? globalThis.String(object.cost_units)
                    : undefined,
        };
    },
    toJSON(message) {
        ...
        return {
            ...
            postBalance: isSet(object.postBalance)
                ...
                : isSet(object.post_balance)
                    ? globalThis.String(object.post_balance)
                    : "0",
...
export const NumPartitions = {
    ...
    fromJSON(object) {
        return {
            numPartitions: isSet(object.numPartitions)
                ? globalThis.String(object.numPartitions)
                : isSet(object.num_partitions)
                    ? globalThis.String(object.num_partitions)
                    : "0",
        };
    },
    toJSON(message) {
