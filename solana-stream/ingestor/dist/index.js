...
class SolanaStreamIngestor {
    ...
    async initialize() {
        ...
        this.redis.subscribe('tier_updates', (err) => {
            if (err)
                logger.error('Failed to subscribe to tier_updates:', err);
        });
    ...
    async startHelius() {
        ...
        try {
            ...
            this.heliusClient = new HeliusClient(this.redisWriter, this.deduplication, {
    ...
    async startChainstack() {
        ...
        try {
            ...
            this.chainstackClient = new ChainstackClient(this.redisWriter, this.deduplication, {
