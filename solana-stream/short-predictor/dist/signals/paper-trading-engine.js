...
export class PaperTradingEngine {
    constructor() {
        ...
        // Logs
        this.logDir = '/data/trinity_apex/solana-stream/short-predictor/logs';
     ...
     */
    async openPosition(decision, coin) {
        // Validation
     ...
     */
    async checkExitConditions(pos, currentPrice) {
     ...
     * Closes a position.
     */
    async closePosition(id, reason, exitPrice) {
