...
import { calculateMarketLayer } from './signals/layer1-market.js';
import { calculateOnChainLayer, fetchHeliusTransactions } from './signals/layer2-onchain.js';
import { calculateNetworkLayer } from './signals/layer3-network.js';
import { makeDecision, logPrediction } from './signals/consensus-engine.js';
import { paperTradingEngine } from './signals/paper-trading-engine.js';
// ============================================================================
// CONSTANTS
// ============================================================================
const PORT = 8080;
...
async function fetchTopCoins() {
    ...
    try {
        ...
        const coins = candidates.map(token => ({
            symbol: token.symbol,
            mint: token.address,
            price: token.price,
 ...
 */
async function updateDexScreenerData(coins) {
 ...
 */
async function processCoinSignals(coin) {
 ...
 */
async function processTrading(coin, prediction) {
...
async function runRankingCycle() {
